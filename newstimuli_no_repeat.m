function varargout = newstimuli_no_repeat(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @newstimuli_no_repeat_OpeningFcn, ...
                   'gui_OutputFcn',  @newstimuli_no_repeat_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function newstimuli_no_repeat_OpeningFcn(hObject, eventdata, handles, varargin)
...
global s_A s_B s_test s_red s_green k controlKey hapSignal ELSignal
...
function varargout = newstimuli_no_repeat_OutputFcn(hObject, eventdata, handles) 
...
redsucceed=0;
global s_A s_B s_test s_red s_green k controlKey hapSignal ELSignal newSignal
global data_red data_green tempData_red tempData_green 
global velo_red velo_green 
global bias
global axes redbutton greenbutton 
...
while greensucceed==0
    ...
    set(axes,'YColor','white');
            ...
            while(1)
                ...
                if(po(1)-ScreenWidth<475 && po(1)-ScreenWidth>379) 
            ...
            intpo=po(1)-ScreenWidth+20;
            while(1)
                po=get(0,'PointerLocation');
                xpointer = po(1)+Xpointer-ScreenWidth ;
    ...
    %sp=patch(axes,Xpatch,ypatch,[0.94902 0.32157 0.36863],'LineStyle','none');
            while toc(timerID)<2
                ...
                sn=sn+1;
                %plot
                xpointer = a(1)+Xpointer-ScreenWidth ;
             ...
             % alpha(sp,0.3)
              drawnow
              if NormalForce<Lowforce*1000 || NormalForce>Highforce*1000
                  if toc(timerID)<1.8
                      redsucceed=0;
             ...
             % alpha(sp,0.3)
              ...
              if NormalForce<Lowforce*1000 || NormalForce>Highforce*1000
                   if toc(timerID)<1.8
                      ...
                      set(handles.text3,'String','Try again!')
                      break;
                   end
              end
            end
                ...
                if green_force_violation==0
                    green_speed = vel_calc(velo_green); 
